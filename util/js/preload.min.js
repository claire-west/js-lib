((dynCore) => {
    dynCore.register({
        ...
        'lib.fragment': () => { !function(f){f.declare("lib.fragment",[f.require("core.namespace"),f.require("lib.model")],function(i,o,r){var e={},n={},l={};return{scan:function(r,n){if(!r||!r.length)throw"Array binding has no template";var o,i,l,f,e=r.get(0).tagName.toLocaleLowerCase();if(e.startsWith("z--"))return o=$.Deferred(),i=(i=e.substring(3)+"-"+(r.attr("z--frag")||"")).split("-").filter(function(e){return e}).join("."),r.removeAttr("z--frag"),l=$("<div/>"),r.replaceWith(l),(f=this).get(i).done(function(t){var e=r.get(0);$.each(e.attributes,function(){this.specified&&t.attr(this.name,this.value)}),f.getController(i,t).done(function(e){l.replaceWith(t),e&&"function"==typeof e&&(e=e(t,n),n=e.model),o.resolve(t,n)}).fail(function(){o.reject()})}).fail(function(){o.reject()}),o},get:function(t){var r=$.Deferred();return n[t]?r.resolve(n[t].clone()):(e[t]=e[t]||$.get(o.fragment(t)),e[t].done(function(e){n[t]=$(e),r.resolve(n[t].clone())}).fail(function(){delete e[t],r.reject()})),r},getController:function(e,t){var r,n;return e&&void 0===t&&l[e]?l[e]:(n=t.attr("z--controller"),t.removeAttr("z--controller"),void 0!==n?(n=""===n?o.controller(e):(e=n,o.controller(n)),void 0!==l[e]?(r=$.Deferred(),l[e].done(function(e){r.resolve(function(){return e.reinit&&e.onInit&&e.onInit(),e})}),r):(l[e]=$.Deferred(),f.js(n),l[e])):$.when())},controller:function(n,o){return l[n]=l[n]||$.Deferred(),l[n].resolve(function(e,t){var r=Object.create(o);return r.$fragment=e,r.model=i.lib.model(r.model,t),r.onInit&&r.onInit(),l[n]=$.when(r),r}),l[n]},instantiate:function(e){var t=$.Deferred();return self.getController(e,$fragment).done(function(e){e&&(e=e($fragment,r),r=e.model),$element.replaceWith($fragment),t.resolve($fragment,r)}).fail(function(){t.reject()}),t}}})}(window.dynCore); },
