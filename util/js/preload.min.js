((dynCore) => {
    dynCore.register({
        ...
        'lib.binarySearch': () => { window.dynCore.declare("lib.binarySearch",function(){function t(n,r,e=function(n,r){return"string"==typeof n||"string"==typeof r?n.localeCompare(r):n-r}){for(var t=0,i=n.length-1;t<=i;){var o=i+t>>1,u=e(r,n[o]);if(0<u)t=1+o;else{if(!(u<0))return o;i=o-1}}return~t}return t.includes=function(n,r,e){return-1<t(n,r,e)},t}); },
