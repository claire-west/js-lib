((dynCore) => {
    dynCore.register({
        ...
        'lib.fragment': () => { !function(f){f.declare("lib.fragment",[f.require("core.namespace"),f.require("lib.model")],function(i,o,e){var n={},l={},c={},a={};return{scan:function(t,n){if(!t||!t.length)throw"Array binding has no template";var o,i,l,c,e=t.get(0).tagName.toLocaleLowerCase();if(e.startsWith("z--"))return o=$.Deferred(),i=(i=e.substring(3)+"-"+(t.attr("z--frag")||"")).split("-").filter(function(e){return e}).join("."),t.removeAttr("z--frag"),l=$("<div/>"),t.replaceWith(l),(c=this).get(i).done(function(r){var e=t.get(0);$.each(e.attributes,function(){this.specified&&r.attr(this.name,this.value)}),c.getController(i,r).done(function(e){l.replaceWith(r),e&&"function"==typeof e&&(e=e(r,n),n=e.model),o.resolve(r,n)}).fail(function(){o.reject()})}).fail(function(){o.reject()}),o},get:function(r){var t=$.Deferred();return l[r]?t.resolve(l[r].clone()):(n[r]=n[r]||$.get(o.fragment(r)),n[r].done(function(e){l[r]=$(e),t.resolve(l[r].clone())}).fail(function(){delete n[r],t.reject()})),t},getController:function(e,r){var t,n;return e&&void 0===r&&c[e]?c[e]:(n=r.attr("z--controller"),r.removeAttr("z--controller"),void 0!==n?(n=""===n?o.controller(e):(e=n,o.controller(n)),void 0!==c[e]?(t=$.Deferred(),a[e].done(function(n,o){t.resolve(function(e,r){var t=Object.create(o);return t.$fragment=e,n.sharedModel?t.model=n.model:t.model=i.lib.model(t.model,r),t.onInit&&t.onInit(),t})}),t):(c[e]=$.Deferred(),a[e]=$.Deferred(),f.js(n),c[e])):$.when())},controller:function(n,o){return c[n]=c[n]||$.Deferred(),a[n]=a[n]||$.Deferred(),c[n].resolve(function(e,r){var t=Object.create(o);return t.$fragment=e,t.model=i.lib.model(t.model,r),t.onInit&&t.onInit(),a[n].resolve(t,o),t},o),a[n]}}})}(window.dynCore); },
